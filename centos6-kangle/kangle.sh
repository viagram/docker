...
wget --no-check-certificate https://raw.githubusercontent.com/viagram/docker/master/centos6-kangle/kangle-3.5.8.tar.gz -O kangle-3.5.8.tar.gz -c
...
make
make install
wget --no-check-certificate https://raw.githubusercontent.com/viagram/docker/master/centos6-kangle/kanglestat -O /vhs/kangle/etc/kanglestat -c
